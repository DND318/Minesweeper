...
public class GamePanel extends JPanel implements MouseListener {
    ...
    public GamePanel(int w, int h, int boom, GameFrame gameFrame) {
        ...
        // Create button array for game board
        world = new World(w, h, boom, this);

        // Set main panel layout and gap
        setLayout(new BorderLayout(20, 20));
        // Top panel with labels and button
        add(p1 = new PanelNotification(this), BorderLayout.NORTH);
        // Panel for game board with GridLayout
                    ...
                    if (e.getButton() == 1 && e.getSource() == arrayButton[i][j] && !world.getArrayCamCo()[i][j]){
                        ...
                        if (!world.open(i,j)){
                            ...
                            if(world.isComplete()){
                                ...
                                getP1().getBt().repaint();
                                int option =  JOptionPane.showConfirmDialog(this, "Do it again! Loser !","I have something to say...",
                            ...
                            world.fullTrue();
                                ...
                                getP1().getBt().repaint();
                                int option =  JOptionPane.showConfirmDialog(this, "Congratulation!, another try ?","I have something to say...", JOptionPane.YES_NO_OPTION);
                                if(option == JOptionPane.YES_NO_OPTION){
                                    //new GamePanel(w,h,boom, gameFrame);
                                    gameFrame.setVisible(false);
                                    new GameFrame(w, h, boom);
